...
public class BatchUpdatePodsSteps extends BaseSteps {
    ...
    public void apiBatchJobUpdateReservationAllOrders(String action, String pickupType, Map<String, String> data) {
        List<String> trackingIds = get(KEY_LIST_OF_CREATED_ORDER_TRACKING_ID);
    ...
    public void apiBatchProofsUpdateReservationAllOrders(String action, String pickupType, Map<String, String> data) {
        List<String> trackingIds = get(KEY_LIST_OF_CREATED_ORDER_TRACKING_ID);
        Map<String, String> resolvedData = resolveKeyValues(data);
        final long reservationId = Long.parseLong(resolvedData.get("reservationId"));
        final long waypointId = Long.parseLong(resolvedData.get("waypointId"));
    ...
    public void apiBatchProofsUpdateReservationPartialSuccess(String pickupType, Map<String, String> data) {
        Map<String, String> resolvedData = resolveKeyValues(data);
        final long reservationId = Long.parseLong(resolvedData.get("reservationId"));
        final long waypointId = Long.parseLong(resolvedData.get("waypointId"));
        final long routeId = Long.parseLong(resolvedData.get("routeId"));
    ...
    public void apiBatchProofsUpdateReservationNoOrders(String action, String pickuptype, Map<String, String> data) {
        Map<String, String> resolvedData = resolveKeyValues(data);
        final long reservationId = Long.parseLong(resolvedData.get("reservationId"));
        final long waypointId = Long.parseLong(resolvedData.get("waypointId"));
        final long routeId = Long.parseLong(resolvedData.get("routeId"));
    ...
    public void apiBatchJobUpdateReservationPartialOrders(String pickupType, Map<String, String> data) {
        List<String> trackingIds = get(KEY_LIST_OF_CREATED_ORDER_TRACKING_ID);
        Map<String, String> resolvedData = resolveKeyValues(data);
        final long reservationId = Long.parseLong(resolvedData.get("reservationId"));
        final long waypointId = Long.parseLong(resolvedData.get("waypointId"));
    ...
    public void apiBatchJobUpdateReservationWithoutOrder(String action, String pickupType, Map<String, String> data) {
        Map<String, String> resolvedData = resolveKeyValues(data);
        final long reservationId = Long.parseLong(resolvedData.get("reservationId"));
        final long waypointId = Long.parseLong(resolvedData.get("waypointId"));
        final long routeId = Long.parseLong(resolvedData.get("routeId"));
        ...
        put(KEY_UPDATE_PODS_JOB_TYPE, jobType);
        doWithRetry(() -> {
            List<JobUpdate> request = createReservationJobWithoutParcelRequest(reservationId, action, jobType);
            getBatchUpdatePodClient().batchUpdatePodJobs(routeId, waypointId, request);
        }, "batch update jobs");
    }
    ...
    private List<JobUpdate> createReservationJobWithoutParcelRequest(Long rsvnId, String jobAction, String jobType) {
        List<JobUpdate> result = new ArrayList<>();
        JobUpdate temp = new JobUpdate();
        temp.setToUpdateJob(true);
        temp.setCommitDate(Instant.now().toEpochMilli());
