...
Feature: PH - FM Automated Routing
  ...
  Scenario Outline: PH - Auto Route Reservation - Date = Today, Creation = After End Clock Time & Run Manual Cron Job, Driver has Existing Route
    ...
    Examples:
      ...
      | {fm-zone-id-1} | {fm-hub-id-1-fm-dedicated} | {fm-driver-1} | {fm-shipper-legacy-id-1-fm-dedicated} | {fm-shipper-id-1-fm-dedicated} | {fm-address-id-1-fm-dedicated} | {fm-shipper-legacy-id-1-truck} | {fm-shipper-id-1-truck} | {fm-address-id-1-truck} |
