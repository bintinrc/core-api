...
Feature: SG - FM Automated Routing - Pickup Appointment Job
  ...
  Scenario Outline: SG - Auto Route PAJ - Order Create Flow, Date = Today, Creation = Within Start & End Clock Time, Driver has No Routes - <Note>
    Given API Route - Operator archive all unarchived routes of driver id "{fm-paj-driver-id-5}"
...
#      | driverId       | {fm-driver-id-5}                         |
    Examples:
      ...
      | Pickup Type: FM Dedicated | 1776842           | { "name": "binti v4.1", "phone_number": "+65189189", "email": "binti@test.co", "address": { "address1": "4 Tuas Link 2", "address2": "#20-25", "country": "SG", "postcode": "638553", "latitude": 1.3368734948599406, "longitude": 103.63925100926828 } } |
